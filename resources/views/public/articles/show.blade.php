...
@php
    ...
    if ($article->thumbnail && file_exists(public_path($article->thumbnail))) {
        $articleSchema['image'] = asset($article->thumbnail);
    }
@endphp
